            ...
            if (movesPending) {
                ...
                adder = new Runnable() {
                    public void run() {
                        ...
                        MyItemAnimator.this.mMovesList.remove(finalAdditions2);
                    }
                };
                if (removalsPending) {
            ...
            if (additionsPending) {
                ...
                adder = new Runnable() {
                    public void run() {
                        ...
                        MyItemAnimator.this.mAdditionsList.remove(finalAdditions1);
                    }
                };
    ...
    void animateChangeImpl(final MyItemAnimator.ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            newViewAnimation.alpha(0.0F).setListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animator) {
                    finalNewViewAnimation.setListener((AnimatorListener) null);
                    view.setAlpha(1.0F);
                    view.setTranslationX(0.0F);
                    view.setTranslationY(0.0F);
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0.0F).translationY(0.0F).setDuration(this.getChangeDuration()).alpha(1.0F).setListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animator) {
                    finalNewViewAnimation1.setListener((AnimatorListener) null);
