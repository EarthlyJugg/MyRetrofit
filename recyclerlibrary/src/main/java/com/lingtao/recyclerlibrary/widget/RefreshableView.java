package com.lingtao.recyclerlibrary.widget;
...
public class RefreshableView extends LinearLayout implements View.OnTouchListener {
    ...
    /**
     * 下拉刷新控件的构造函数，会在运行时动态添加一个下拉头的布局。	 * 	 * @param context	 * @param attrs
     */
...
//            int firstVisiblePos = listView.getFirstVisiblePosition();
            ...
            Log.d("nongyulian", "firstVisiblePos=" + firstVisiblePos + ",getTop()=" + firstChild.getTop());
     ...
     * @param colorResIds
     */
    public void setProgressBarColor(@ColorRes int... colorResIds) {
    }
     ...
     * @param colors
     */
    public void setProgressBarStyle(int... colors) {
    }

    /**
     * 正在刷新的任务，在此任务中会去回调注册进来的下拉刷新监听器。	 * 	 * @author guolin
     */
