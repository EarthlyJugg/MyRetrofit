...
import com.lingtao.recyclerlibrary.cell.EmptyCell;
import com.lingtao.recyclerlibrary.cell.ErrorCell;
import com.lingtao.recyclerlibrary.cell.LoadMoreCell;
...
public class RVSimpleAdapter extends RvBaseAdapter {
    ...
    public RVSimpleAdapter() {
        this.mEmptyCell = new EmptyCell();
        this.mErrorCell = new ErrorCell();
        this.mLoadingCell = new LoadingCell();
